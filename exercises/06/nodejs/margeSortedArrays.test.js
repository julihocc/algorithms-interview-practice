...
test('Edge Case: Arrays with negative numbers', () => {
    const negativeArray1 = [-3, -1, 0, 0, 0];
    const negativeArray2 = [-4, -2];
...
test('Edge Case: Arrays with duplicate numbers', () => {
    const duplicateArray1 = [1, 1, 1, 0, 0, 0];
    const duplicateArray2 = [1, 1, 1];
...
test('Edge Case: Arrays with only one element each', () => {
    const singleElementArray1 = [1, 0];
    const singleElementArray2 = [2];
