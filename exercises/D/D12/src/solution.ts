...
function getUnknownParentAlleles(otherParent: BloodType, child: BloodType): Set<BloodType> {
  if (child === "O") {
    ...
    switch (otherParent) {
      case "O": return NONE_POSSIBLE;
      case "AB": return new Set([...A_POSSIBLE, ...B_POSSIBLE, ...AB_POSSIBLE]);
      case "A": return new Set([...B_POSSIBLE, ...AB_POSSIBLE]);
      default: return new Set([...A_POSSIBLE, ...AB_POSSIBLE]);
    }
  }
}
